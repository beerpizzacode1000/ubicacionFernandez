...
<head>
<meta charset=utf-8>
<title>Localización Fernandez!</title>
...
<script>
	...
	function initalizeMap() {
		...
		var goal = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/chequered_flag.png',size2,offset);
        var icon = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/marker1.png',size,offset);
		var icon2 = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/marker2.png',size,offset);
		var icon3 = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/marker3.png',size,offset);
		var icon4 = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/marker4.png',size,offset);
		var icon5 = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/marker5.png',size,offset);
		var icon6 = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/marker6.png',size,offset);
		var icon7 = new OpenLayers.Icon('http://proyectofernandez.ueuo.com/gps/img/marker7.png',size,offset);
